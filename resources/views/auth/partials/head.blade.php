...
<link rel="shortcut icon" href="{{ url('assets/nn_cms/layouts/layout/img/favicon.png') }}" />
...
<link href="{{ url('assets/nn_cms/global/plugins/animate/animate.css') }}" rel="stylesheet" type="text/css" />
...
<link href="{{ url('assets/nn_cms/pages/css/auth.min.css') }}" rel="stylesheet" type="text/css" />
