...
@section('content')
    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> {{ trans('general.ptCollection') }}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <a href="{{ url(getCurrentLocale() . '/manager/collection/' . $item->id . '/' . ($item->type == "gallery" ? "gallery":'catalog')  ) }}" class="btn btn-icon-only green">
                                        ...
                                        <a href="javascript:;" class="btn btn-primary red del" data-toggle="modal" data-target="#delete-item" data-element-id="{{ $item->id }}" data-delete-url="collection/destroy" data-item-id="{{ $item->id }}" data-item-type="{{ $item->type }}">
