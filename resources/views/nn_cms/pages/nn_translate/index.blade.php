    ...
    <div class="page-content">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                <a href="{{ url(getCurrentLocale() . '/manager/translate/create') }}" class="btn green-seagreen btn-outline sbold uppercase" data-action="collapse-all">{{ trans('general.cAddNew') }}</a>

                <a href="{{ url(getCurrentLocale() . '/manager/translate/generate') }}" class="btn btn-icon-only blue sbold uppercase">Save changes&nbsp;&nbsp;<i class="fa fa-save"></i></a>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <a href="{{ url(getCurrentLocale() . '/manager/translate/' . $item->id . '/edit') }}" class="btn btn-icon-only blue">
                                        ...
                                        <a href="javascript:;" class="btn btn-primary red del" data-toggle="modal" data-target="#delete-item" data-element-id="{{ $item->id }}" data-delete-url="translate/destroy">
