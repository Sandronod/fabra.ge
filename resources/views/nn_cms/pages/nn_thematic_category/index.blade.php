    ...
    <div class="page-content">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                <a href="{{ url(getCurrentLocale() . '/manager/thematic_category/create') }}" class="btn blue btn-outline sbold uppercase" data-action="collapse-all">{{ trans('general.cAddNew') }}</a>
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-title">
                ...
                <div class="caption">
                    ...
                    <i class="fa fa-cogs"></i> {{ trans('general.yourThematicCategories') }}  </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <a href="{{ url(getCurrentLocale() . '/manager/thematic_category/' . $item->id . '/edit') }}" class="btn btn-icon-only blue">
                                        ...
                                        <a href="javascript:;" class="btn btn-primary red del" data-toggle="modal" data-target="#delete-item" data-element-id="{{ $item->id }}" data-delete-url="thematic_category/destroy">
