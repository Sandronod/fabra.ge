...
@section('content')
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> {{ trans('general.ptGallery') }}
        </h3>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        ...
        <div class="portlet light bordered">
            <div class="portlet-body">
                <a href="{{ url(getCurrentLocale() . '/manager/collection/' . $collection->id . '/gallery/create') }}" class="btn purple-wisteria btn-outline sbold uppercase" data-action="collapse-all">{{ trans('general.cAddNew') }}</a>
            </div>
        </div>
        <div class="portlet box purple-wisteria">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i> {{ trans('general.yourGallery') }} </div>
                <div class="tools">
                    ...
                    <table class="data-table table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="clearfix">
                                        <a href="{{ url(getCurrentLocale() . '/manager/collection/' . $collection->id . '/gallery/' . $item->id . '/items') }}" class="btn btn-icon-only green">
                                            <i class="fa fa-th"></i>
                                        </a>
                                        <a href="{{ url(getCurrentLocale() . '/manager/collection/' . $collection->id . '/gallery/' . $item->id . '/edit') }}" class="btn btn-icon-only blue">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <!-- Button trigger modal -->
                                        <a href="javascript:;" class="btn btn-primary red del" data-toggle="modal" data-target="#delete-item" data-element-id="{{ $item->id }}" data-delete-url="gallery/destroy">
