...
@section('content')
    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> {{ trans('general.ptArticle') }}
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                <a href="{{ url(getCurrentLocale() . '/manager/collection/'.$collection->id.'/article/create') }}" class="btn green-seagreen btn-outline sbold uppercase" data-action="collapse-all">{{ trans('general.cAddNew') }}</a>
        ...
        <div class="portlet box green-seagreen">
            ...
            <div class="portlet-title">
                ...
                <div class="caption">
                    ...
                    <i class="fa fa-cogs"></i> {{ trans('general.yourArticles') }} </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="clearfix">
                                        ...
                                        <a href="{{ url(getCurrentLocale() . '/manager/collection/' . $collection->id . '/article/' . $item->id . '/edit') }}" class="btn btn-icon-only blue">
                                        ...
                                        <a href="javascript:;" class="btn btn-primary red del" data-toggle="modal" data-target="#delete-item" data-element-id="{{ $item->id }}" data-delete-url="article/destroy">
