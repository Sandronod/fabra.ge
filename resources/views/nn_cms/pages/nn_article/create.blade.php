...
@section('content')
    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> {{ trans('general.ptCreateArticle') }}
        ...
        <a href="{{ url(getCurrentLocale() . '/manager/collection/' . $collection->id . '/article') }}" class="btn green btn-outline sbold uppercase margin-bottom-20"><i class="fa fa-arrow-left"></i> {{ trans('general.back') }}</a>
