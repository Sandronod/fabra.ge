...
@section('content')
    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> {{ trans('general.ptEditInfo') }}
        ...
        <a href="{{ url(getCurrentLocale() . '/manager/collection/' . $collectionId . '/info') }}" class="btn green btn-outline sbold uppercase margin-bottom-20" data-action="collapse-all"><i class="fa fa-arrow-left"></i> {{ trans('general.back') }}</a>
                    ...
                    <div class="clearfix">
                        ...
                        <ul class="nav nav-tabs pull-right">
                            ...
                            <li>
                                ...
                                <a href="{{ url(getCurrentLocale() . '/manager/collection/' . $collectionId . '/info/' . $infoId . '/file') }}"><i class="fa fa-paperclip"></i> {{ trans('general.attachFiles') }}</a>
                            ...
                            <li>
                                ...
                                <a href="{{ url(getCurrentLocale() . '/manager/collection/' . $collectionId . '/info/' . $infoId . '/image') }}"><i class="fa fa-file-image-o"></i> {{ trans('general.attachImages') }}</a>
                    ...
                    <div class="tab-content">
                        ...
                        @for($i = 0; $i < count($langs); $i++)
                            ...
                            <div id="tab_{{ $i }}" class="tab-pane @if($langs[$i] == getCurrentLocale()) {{ 'active' }} @endif">
                                ...
                                {!! Form::open(array('method' => 'PATCH', 'url' => getCurrentLocale().'/manager/collection/' . $info[$i]->id . '/info/update', 'id' => 'form_' . $langs[$i], 'class' => 'form-horizontal form_ajax')) !!}
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <input type="text" name="name" class="form-control input-lg" value="{{ $info[$i]->name }}">
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                              ...
                                              <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
                                                            <input type="text" name="AstartDate"  class="form-control" value="{{ $infoDates[0]->AstartDate }}" readonly="">
                                                ...
                                                <div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="+0d">
                                                            <input type="text" name="AendDate" class="form-control" value="{{ $infoDates[0]->AendDate }}" readonly="">
                                                            <span class="input-group-btn">
                                                                <button class="btn default" type="button">
                                                                    <i class="fa fa-calendar"></i>
                                                                </button>
                                                        ...
                                                        <input name="AstartTime" type="text" value="{{ $infoDates[0]->AstartTime }}"  class="form-control timepicker timepicker-24">
                                                        <span class="input-group-btn">
                                                            <button class="btn default" type="button">
                                                    ...
                                                    <div class="input-group">
                                                        <input name="AendTime" type="text" value="{{ $infoDates[0]->AendTime }}" class="form-control timepicker timepicker-24">
                                                        <span class="input-group-btn">
                                                            <button class="btn default" type="button">
                                                                <i class="fa fa-clock-o"></i>
                                                            </button>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="photo">
                                                    ...
                                                    <img src="{{ (!empty($info[$i]->imgurl)) ? $info[$i]->imgurl : url('assets/nn_cms/custom/images/default-780x450.png') }}" data-default-photo-src="{{ url('assets/nn_cms/custom/images/default-780x450.png') }}" id="showImg_{{$langs[$i]}}" class="img-responsive img-thumbnail center-block img" alt="info photo">


                                                    <input type="hidden" name="imgurl" id="imgurl_{{ $langs[$i]}}"  data-required="1" class="form-control" value="{{ $info[$i]->imgurl }}">
                                        ...
                                        <div class="form-group last">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <textarea type="text" name="description" class="form-control input-lg">{{ $info[$i]->description }}</textarea>
