...
@section('content')
    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> {{ trans('general.ptImage') }}
            ...
            <div class="portlet-body clearfix">
                ...
                <ul class="list-inline pull-left">
                    ...
                    <li>
                        ...
                        <a href="#add-image" class="btn blue btn-outline sbold uppercase add-new-file" data-toggle="modal" data-target="#add-image">{{ trans('general.cAddNew') }}</a>
                    ...
                    <div class="clearfix">
                        ...
                        <ul class="nav nav-tabs pull-right">
                            ...
                            <li>
                                ...
                                <a href="{{ url(getCurrentLocale() . '/manager/' . $type . '/' . $main_id . '/' . $route_name . '/' . $route_id . '/file') }}"><i class="fa fa-paperclip"></i> {{ trans('general.attachFiles') }}</a>

                            </li>

                            <li class="active">

                                <a nohref><i class="fa fa-file-image-o"></i> {{ trans('general.attachImages') }}</a>
                                ...
                                <div class="draggable-box">
                                    ...
                                    <div class="draggable-box-title ui-sortable-handle">
                                        ...
                                        <div class="actions">
                                            ...
                                            <a href="#edit-image" class="btn blue-sharp btn-circle btn-sm edit" rel="tooltip" data-placement="top" title="{{ trans('general.edit') }}" data-toggle="modal" data-target="#edit-image">
    ...
    <div class="modal fade" id="add-image" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                {!! Form::open(array('url' => getCurrentLocale() . '/manager/collection/' . $main_id . '/' . $route_name . '/' . $route_id . '/image/store', 'files' => true, 'class' => 'form')) !!}
                            ...
                            <div class="tab-content">
                                ...
                                @for($i = 0; $i < count($langs); $i++)
                                    ...
                                    <div id="tab_{{ $i }}" class="tab-pane @if($langs[$i] == getCurrentLocale()) {{ 'active' }} @endif">
                                        ...
                                        {!! Form::open(array('url' => getCurrentLocale() . '/manager/collection/' . $main_id . '/' . $route_name . '/' . $route_id . '/image/update', 'files' => true, 'class' => 'form')) !!}
    ...
    <script src="{{ url('assets/nn_cms/custom/js/filemanager-image.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ url('assets/nn_cms/custom/js/image-edit-delete.js') }}" type="text/javascript"></script>

        <script src="{{ url('assets/nn_cms/custom/js/image-actions.js') }}" type="text/javascript"></script>
