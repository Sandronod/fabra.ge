...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
        ...
        <li class="nav-item<?php if(Request::is('*/manager')): ?> start active open<?php endif; ?>">
            ...
            <a href="{{ url(getCurrentLocale() . '/manager') }}" class="nav-link ">
        ...
        <li class="nav-item<?php if(Request::is('*/user/*')): ?> start active open<?php endif; ?>">
            ...
            <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <span class="title">{{ trans('general.user') }}</span>
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item<?php if(Request::is('*/profile')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/user/profile') }}" class="nav-link ">



                        <span class="title">{{ trans('general.fclbPersonalInfoMIN') }}</span>
                ...
                <li class="nav-item<?php if(Request::is('*/profile/photo')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/user/profile/photo') }}" class="nav-link ">



                        <span class="title">{{ trans('general.fclbChangePhoto') }}</span>
                ...
                <li class="nav-item<?php if(Request::is('*/profile/password')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/user/profile/password') }}" class="nav-link ">



                        <span class="title">{{ trans('general.fclbChangePassword') }}</span>
        ...
        <li class="nav-item<?php if(Request::is('*/menu/*') || Request::is('*/menu')): ?> start active open<?php endif; ?>">
            ...
            <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <span class="title">{{ trans('general.menu') }}</span>
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item<?php if(Request::is('*/menu')): ?> start active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/menu') }}" class="nav-link">



                    {{ trans('general.allMenus') }} </a>
                ...
                <li class="nav-item<?php if(Request::is('*/menu/create') || Request::is('*/menu/*')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/menu/create') }}" class="nav-link">



                    {{ trans('general.createMenu') }} </a>
        ...
        <li class="nav-item<?php if(Request::is('*/collection/*') || Request::is('*/collection')): ?> start active open<?php endif; ?>">
            ...
            <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <span class="title">{{ trans('general.collection') }}</span>
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item<?php if(Request::is('*/collection')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/collection') }}" class="nav-link">
                ...
                <li class="nav-item<?php if(Request::is('*/collection/create') || Request::is('*/collection/*')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/collection/create') }}" class="nav-link">



                        {{ trans('general.addNew') }} </a>
        ...
        <li class="nav-item<?php if(Request::is('*/category/*') || Request::is('*/category')): ?> start active open<?php endif; ?>">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item<?php if(Request::is('*/category')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/category') }}" class="nav-link">
                ...
                <li class="nav-item<?php if(Request::is('*/category/create') || Request::is('*/category/*')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/category/create') }}" class="nav-link">
        ...
        <!-- <li class="nav-item<?php if(Request::is('*/thematic_category/*') || Request::is('*/thematic_category')): ?> start active open<?php endif; ?>">
            ...
            <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <span class="title">{{ trans('general.thematicCategory') }}</span>
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item<?php if(Request::is('*/thematic_category')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/thematic_category') }}" class="nav-link">
                ...
                <li class="nav-item<?php if(Request::is('*/thematic_category/create') || Request::is('*/thematic_category/*')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/thematic_category/create') }}" class="nav-link">
        ...
        <!-- <li class="nav-item<?php if(Request::is('*/color/*') || Request::is('*/color')): ?> start active open<?php endif; ?>">
            ...
            <a href="javascript:;" class="nav-link nav-toggle">
                ...
                <span class="title">{{ trans('general.color') }}</span>
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item<?php if(Request::is('*/color')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/color') }}" class="nav-link">
                ...
                <li class="nav-item<?php if(Request::is('*/color/create') || Request::is('*/color/*')): ?> active open<?php endif; ?>">
                    ...
                    <a href="{{ url(getCurrentLocale() . '/manager/color/create') }}" class="nav-link">
        ...
        <li class="nav-item<?php if(Request::is('*/slider')): ?> start active<?php endif; ?>">
            ...
            <a href="{{ url(getCurrentLocale() . '/manager/slider') }}" class="nav-link nav-toggle filemanager-btn-sidebar">
                ...
                <span class="title">{{ trans('general.slider') }}</span>
...
{{--
        <li class="nav-item<?php if(Request::is('*/site-users') || Request::is('*/companies') || Request::is('*/transactions')): ?> start active<?php endif; ?>">
            <a href="{{ url(getCurrentLocale() . '/manager/site-users') }}" class="nav-link nav-toggle filemanager-btn-sidebar">
                ...
                <?php if(Request::is('*/site-users') || Request::is('*/companies') || Request::is('*/transactions')): ?><span class="selected"></span><?php endif; ?>

            </a>
        </li>

        <li class="nav-item<?php if(Request::is('*/job')): ?> start active<?php endif; ?>">

            <a href="{{ url(getCurrentLocale() . '/manager/job') }}" class="nav-link nav-toggle filemanager-btn-sidebar">

                <i class="icon-layers"></i>

                <span class="title">პროექტები</span>
        ...
        <li class="nav-item<?php if(Request::is('*/filemanager')): ?> start active<?php endif; ?>">
            ...
            <a href="{{ url(getCurrentLocale() . '/manager/filemanager') }}" class="nav-link nav-toggle filemanager-btn-sidebar">
                ...
                <span class="title">{{ trans('general.filemanager') }}</span>
        ...
        <li class="nav-item<?php if(Request::is('*/translate')): ?> start active<?php endif; ?>">
            ...
            <a href="{{ url(getCurrentLocale() . '/manager/translate') }}" class="nav-link nav-toggle filemanager-btn-sidebar">
        ...
        <li class="nav-item<?php if(Request::is('*/site-settings')): ?> start active<?php endif; ?>">
            ...
            <a href="{{ url(getCurrentLocale() . '/manager/site-settings') }}" class="nav-link nav-toggle filemanager-btn-sidebar">

                <i class="icon-settings"></i>

                <span class="title">{{ trans('general.siteSettings') }}</span>
        ...
        <!-- <li class="nav-item<?php if(Request::is('*/orders')): ?> start active<?php endif; ?>">
            ...
            <a href="{{ url(getCurrentLocale() . '/manager/orders') }}" class="nav-link nav-toggle filemanager-btn-sidebar">
