                    ...
                    <div id="grid" class="row">
                        ...
                        <div class="col-md-6 col-12 mt-4  pt-2 {{$key === 0 ? 'pt-sm-0 mt-sm-0' : ''}} picture-item">
                            <div class="card portfolio portfolio-modern portfolio-primary rounded overflow-hidden shadow rounded">
                                <a href="{{fullUrl('list/'.$product->parentItem->slug.'/'.$product->slug)}}" >
                                    <img src="{{$product->lang->imgurl}}" class="img-fluid" alt="">
                                </a>
                                <div class="content text-center p-3">
                                    <a href="{{fullUrl('list/'.$product->parentItem->slug.'/'.$product->slug)}}" class="text-dark h6 mb-0 d-block title">{{$product->lang->name}}</a>
                                </div>
                            </div>
                        </div><!--end col-->
                        @endforeach
