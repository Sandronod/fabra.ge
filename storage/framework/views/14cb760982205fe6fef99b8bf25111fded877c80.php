...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-content">
        ...
        <h3 class="page-title"> <?php echo e(trans('general.ptImage')); ?>
            ...
            <div class="portlet-body clearfix">
                ...
                <ul class="list-inline pull-left">
                    ...
                    <li>
                        ...
                        <a href="#add-image" class="btn blue btn-outline sbold uppercase add-new-file" data-toggle="modal" data-target="#add-image"><?php echo e(trans('general.cAddNew')); ?></a>
                ...
                <div class="tabbable-line">
                    ...
                    <div class="clearfix">
                        ...
                        <ul class="nav nav-tabs pull-right">
                            ...
                            <li>
                                ...
                                <a href="<?php echo e(url(getCurrentLocale() . '/manager/' . $type . '/' . $main_id . '/' . $route_name . '/' . $route_id . '/file')); ?>"><i class="fa fa-paperclip"></i> <?php echo e(trans('general.attachFiles')); ?></a>

                            </li>

                            <li class="active">

                                <a nohref><i class="fa fa-file-image-o"></i> <?php echo e(trans('general.attachImages')); ?></a>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="row ui-sortable" id="sortable" data-route_name="<?php echo e($route_name); ?>" data-route_id="<?php echo e($route_id); ?>">
                            ...
                            <?php $__currentLoopData = $imageItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="draggable-box">
                                    ...
                                    <div class="draggable-box-title ui-sortable-handle">
                                        ...
                                        <div class="actions">
                                            ...
                                            <a href="#edit-image" class="btn blue-sharp btn-circle btn-sm edit" rel="tooltip" data-placement="top" title="<?php echo e(trans('general.edit')); ?>" data-toggle="modal" data-target="#edit-image">
    ...
    <div class="modal fade" id="add-image" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <?php echo Form::open(array('url' => getCurrentLocale() . '/manager/collection/' . $main_id . '/' . $route_name . '/' . $route_id . '/image/store', 'files' => true, 'class' => 'form')); ?>
                            ...
                            <div class="tab-content">
                                ...
                                <?php for($i = 0; $i < count($langs); $i++): ?>
                                    ...
                                    <div id="tab_<?php echo e($i); ?>" class="tab-pane <?php if($langs[$i] == getCurrentLocale()): ?> <?php echo e('active'); ?> <?php endif; ?>">
                                        ...
                                        <?php echo Form::open(array('url' => getCurrentLocale() . '/manager/collection/' . $main_id . '/' . $route_name . '/' . $route_id . '/image/update', 'files' => true, 'class' => 'form')); ?>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img src="<?php echo e(url('assets/nn_cms/custom/images/default-780x450.png')); ?>" id="showImg_<?php echo e($langs[$i]); ?>"  class="img-responsive img-thumbnail center-block" alt="article photo">
    ...
    <script src="<?php echo e(url('assets/nn_cms/custom/js/filemanager-image.js')); ?>" type="text/javascript"></script>
        ...
        <script src="<?php echo e(url('assets/nn_cms/custom/js/image-edit-delete.js')); ?>" type="text/javascript"></script>

        <script src="<?php echo e(url('assets/nn_cms/custom/js/image-actions.js')); ?>" type="text/javascript"></script>
...
<?php echo $__env->make('../nn_cms/index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\projects\laravel\fabra.ge\resources\views/nn_cms/pages/nn_image/index.blade.php ENDPATH**/ ?>