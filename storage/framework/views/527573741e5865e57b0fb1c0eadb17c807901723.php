                                            ...
                                            <ul>
                                                ...
                                                <?php if(isset($menuItem->subMenu[0])): ?>
                                                    <?php $__currentLoopData = $menuItem->subMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li><a href="<?php echo e(fullUrl('list/'.$subItem->parentItem->slug.'/'.$subItem->slug)); ?>" class="sub-menu-item"><?php echo e($subItem->lang->name); ?></a></li>
...
<!-- Navbar End -->
<?php /**PATH C:\projects\laravel\fabra.ge\resources\views/nn_site/partials/header.blade.php ENDPATH**/ ?>